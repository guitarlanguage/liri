...
.env
```
* Files that begin with . are hidden files and to list them in the terminal, use "ls -a". If you're using Visual Studio Code, install the code PATH plugin to quickly open files for editing from the command line. 
Mac instructions to type "code <filename>" https://code.visualstudio.com/docs/setup/mac#_launching-from-the-command-line
